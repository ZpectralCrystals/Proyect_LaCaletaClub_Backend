...
ALLOWED_HOSTS = ['*']  # Permitir todas las IPs, o puedes limitar a tu dominio en producción
...
# Port
PORT = os.getenv('PORT', '8000')  # Render assigns a dynamic port, and you can set it through this environment variable.
